...
var REG_IMAGE_CALIBRATION        = 0x3b;
var REG_TEMPERATURE              = 0x3c;
...
var MODE_SLEEP                   = 0x00;
var MODE_STDBY                   = 0x01; // rf and pll disabled
var MODE_FSTX                    = 0x02; // frequency synthesis tx
var MODE_TX                      = 0x03;
var MODE_FSRX                    = 0x04; // frequency synthesis rx
...
var RF_IMAGECAL_TEMPMONITOR_OFF  = 0x01;
var RF_IMAGECAL_TEMPMONITOR_ON   = 0x00;
var RF_IMAGECAL_TEMPMONITOR_MASK = 0xFE
...
SX127x.prototype.readTemperature = async function(err, value) {
  ...
  await this._writeRegister(REG_IMAGE_CALIBRATION, 
    (await this._readRegister(REG_IMAGE_CALIBRATION) & RF_IMAGECAL_TEMPMONITOR_MASK) | (RF_IMAGECAL_TEMPMONITOR_ON));
  ...
  await this._writeRegister(REG_IMAGE_CALIBRATION, 
    (await this._readRegister(REG_IMAGE_CALIBRATION) & RF_IMAGECAL_TEMPMONITOR_MASK) | (RF_IMAGECAL_TEMPMONITOR_OFF));
